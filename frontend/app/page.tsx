...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden bg-[#0F0F1A]">
      {/* Image de fond */}
      <div
      ...
      {/* Contenu (relatif pour être au-dessus du fond) */}
